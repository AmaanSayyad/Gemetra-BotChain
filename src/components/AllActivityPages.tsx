...
export const AllActivityPage: React.FC<AllActivityPageProps> = ({
  ...
  return (
    <div className="min-h-screen min-w-0 bg-gray-50 sm:bg-white">
      <div className="w-full min-w-0 max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 py-3 sm:py-8">
                        ...
                        <div className="mb-2">
                          ...
                          >
                            <span className="font-mono">
                              {activity.transactionHash.substring(0, 10)}...{activity.transactionHash.substring(activity.transactionHash.length - 8)}
                            </span>
