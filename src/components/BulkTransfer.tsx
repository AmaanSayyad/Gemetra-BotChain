...
export const BulkTransfer: React.FC<BulkTransferProps> = ({ 
  ...
  return (
    <>
      <div className="w-full min-w-0 max-w-6xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 sm:mb-8 space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-3 sm:space-x-4">
              <div className="text-center sm:text-right">
                ...
                <div className="text-base sm:text-xl font-bold text-black">{totalAmount.toLocaleString()} {selectedToken}</div>
              </div>
            </div>
          </div>

          {/* Network Warning */}
          {isWalletConnected && <NetworkWarning selectedToken={selectedToken} />}
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 sm:p-6">
                ...
                <div className="space-y-2 sm:space-y-3">
                  ...
                  <div className="flex items-center justify-between p-2 sm:p-3 bg-white border border-gray-200 rounded-lg">
                    ...
                    <span className="font-semibold text-green-600 text-sm sm:text-base">{totalAmount.toLocaleString()} {selectedToken}</span>
                  </div>
                </div>
