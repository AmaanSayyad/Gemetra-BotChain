...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const avatarSeed = (value: string) =>
    (value || 'default').split('').reduce((acc, char) => (acc * 31 + char.charCodeAt(0)) % 1000, 7);
  ...
  const navigationItems = [
    ...
    },
    {
      ...
      label: 'VAT Admin',
      icon: Shield,
      description: 'VAT refunds overview & export'
    },
    {
      id: 'ai-assistant',
      label: 'AI Assistant',
                ...
                >
                  <div className="relative">
                    <div className={`${
                      ...
                      <img
                        src={`https://noun.pics/${avatarSeed(walletAddress)}.svg`}
                        alt="Profile"
